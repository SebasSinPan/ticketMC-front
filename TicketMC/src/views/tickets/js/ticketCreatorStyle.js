//El modal de crear ticket sólo está disponible para los usuarios
//se hace primero la validación del user para evitar llamados vacios
if (localStorage.getItem('rol') == 'user'){
    ...
    //evento que abre el modal de cración de tickets
    //si se clickea sobre el elemento indicado
