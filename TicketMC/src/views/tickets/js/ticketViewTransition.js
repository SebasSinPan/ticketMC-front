...
//ya que en los filtras también hay entradas a este tipo de tickts
const filterOpenBtn = document.getElementById('btns-activeOpenTicketsView');
const filterClosedBtn = document.getElementById('btns-activeClosedTicketsView');
const filterAllBtn = document.getElementById('btns-activeAllTicketsView');
...
// Página principal de tickets
filterOpenBtn.addEventListener('click', ev =>{
    ev.preventDefault();
...
// Página de ticket solucionados
filterClosedBtn.addEventListener('click', ev =>{
    ev.preventDefault();
...
// Página de todos los tickets
filterAllBtn.addEventListener('click', ev =>{
    ev.preventDefault();
